    ...
    <footer className="bg-gray-900 text-white">
      ...
      <div className="container-custom py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-ent-primary to-ent-secondary rounded-lg flex items-center justify-center">
                  <span className="text-white font-bold text-lg sm:text-xl">선</span>
                </div>
                <div>
                  <h3 className="text-xl sm:text-2xl font-bold">선우 이비인후과</h3>
                  <p className="text-gray-400 text-sm sm:text-base">미금역 3분, 전문 진료</p>
                </div>
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <Phone size={16} className="text-ent-primary sm:w-[18px] sm:h-[18px]" />
                <span className="font-semibold text-base sm:text-lg">{contactInfo.phone}</span>
              </div>
              <div className="flex items-start space-x-3">
                <MapPin size={16} className="text-ent-primary mt-1 sm:w-[18px] sm:h-[18px]" />
                <div>
                  <p className="text-sm sm:text-base">{contactInfo.address}</p>
                  <p className="text-gray-400 text-xs sm:text-sm">{contactInfo.subway}</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <Mail size={16} className="text-ent-primary sm:w-[18px] sm:h-[18px]" />
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-base sm:text-lg font-semibold mb-4 sm:mb-6">빠른 메뉴</h4>
            <ul className="space-y-2 sm:space-y-3">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <a 
                    href={link.href}
                    className="text-gray-300 hover:text-ent-primary transition-colors duration-200 text-sm sm:text-base"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          {/* Services */}
          <div>
            <h4 className="text-base sm:text-lg font-semibold mb-4 sm:mb-6">주요 진료과목</h4>
            <ul className="space-y-2 sm:space-y-3">
        ...
        {/* Operating Hours */}
        <div className="mt-12 sm:mt-16 pt-8 sm:pt-12 border-t border-gradient-to-r from-transparent via-gray-700 to-transparent">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-start">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-gray-700/50">
              <h4 className="text-lg sm:text-xl font-display font-bold mb-4 sm:mb-6 flex items-center text-white">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-ent-primary to-blue-600 rounded-xl flex items-center justify-center mr-3">
              ...
              <div className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-center justify-between p-3 sm:p-4 rounded-xl bg-gray-700/30 border border-gray-600/30">
                    <div className="flex items-center space-x-2 sm:space-x-3">
                      <div className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full bg-gradient-to-r ${schedule.color}`}></div>
                      <span className="text-gray-200 font-medium text-sm sm:text-lg">{schedule.label}</span>
                    </div>
                    <span className="text-white font-bold text-sm sm:text-lg">{schedule.time}</span>
                  </div>
                ))}
                <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-orange-500/10 border border-orange-500/20 rounded-xl">
                  <p className="text-orange-300 font-semibold flex items-center text-sm sm:text-base">
                    <div className="w-2 h-2 bg-orange-400 rounded-full mr-2 sm:mr-3"></div>
            ...
            {/* Emergency Contact */}
            <div className="bg-gradient-to-br from-ent-primary/20 via-blue-600/15 to-purple-600/10 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-ent-primary/20 relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-ent-primary/5 to-transparent"></div>
              <div className="relative">
                <div className="flex items-center mb-4 sm:mb-6">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-red-500 to-pink-600 rounded-2xl flex items-center justify-center mr-3 sm:mr-4">
                    <Phone size={20} className="text-white sm:w-6 sm:h-6" />
                  </div>
                  <h4 className="text-lg sm:text-xl font-display font-bold text-white">응급 상담</h4>
                </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <button className="btn-primary w-full text-base sm:text-lg py-3 sm:py-4 rounded-xl font-bold">
                    응급 상담하기
                  </button>
