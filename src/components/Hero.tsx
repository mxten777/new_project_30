        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full border border-white/20 mb-4">
                <div className="w-3 h-3 bg-green-400 rounded-full mr-3 animate-pulse"></div>
                <span className="text-white/90 font-semibold text-lg">15년 경력 전문의 직접 진료</span>
              </div>
              
              <h1 className="text-6xl lg:text-8xl font-display font-black leading-none tracking-tight">
                <span className="block bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent drop-shadow-2xl">
                  선우 이비인후과
                </span>
              </h1>
              
              <p className="text-2xl lg:text-3xl text-blue-100/90 font-medium leading-relaxed">
                <span className="block mb-2">미금역 3분, 유종선 원장의</span>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <button className="btn-primary text-xl py-5 px-10 rounded-2xl font-bold shadow-2xl hover:shadow-white/20 transform hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-3 min-w-[200px]">
                <span>온라인 예약</span>
                <ArrowRight size={24} className="group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="btn-secondary text-xl py-5 px-10 rounded-2xl font-bold border-2 border-white/50 hover:border-white shadow-xl hover:shadow-white/10 transform hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-3 min-w-[200px]">
                <Phone size={24} />
                <span>전화상담</span>
              </button>
            </div>
